      ...
      <div className="rounded-2xl border bg-card p-8 max-w-md w-full space-y-4">
        <div className="flex justify-center">
          <div className="rounded-full bg-muted p-4">
            <ModuleIcon moduleId="client_portal" size="lg" />
          </div>
        </div>
        <div className="space-y-2">
          <h2 className="text-xl font-semibold">Client Portal Settings</h2>
          <p className="text-sm text-muted-foreground">
            Settings for the Client Portal module are coming soon.
