...
/** Inline SVG brand icons for each social platform */
function PlatformSvg({ platform, size = 20 }: { platform: string; size: number }) {
  ...
  switch (platform) {
    ...
    default:
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="#888">
...
export function getPlatformColor(platform: string): string {
  return platformColors[platform] ?? '#888';
}
